...
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Email ID</b>  <input type="email" name="email" class="form-control" id="email" placeholder="Register Email ID" required="">
	</p> 

	<p style="width: 350px;">
		
			<b>Mobile Number</b>  <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Register Mobile Number" required="">
	</p> 
